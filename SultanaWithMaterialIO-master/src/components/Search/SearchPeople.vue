<template>
    <v-app>
        <v-layout column align-center>
            ...
            <v-card :width=2000 class="ml-2 mr-2" outlined :color=primaryColor dark>
            ...
            <v-card :width=2000 class="ml-2 mt-2 mr-2" outlined :color=primaryColor dark>
                <v-card-title primary-title class="justify-center ml-2">
                    Crew Search
                    <v-spacer></v-spacer>
                    <v-text-field 
        ...
        <v-dialog v-model="prisonerDialog" max-width="800">
            <v-card color=#ebfffe light outlined>
                ...
                <v-card-actions>
                    <v-btn :color=secondaryColor text @click="prisonerDialog = false">Close</v-btn>
                </v-card-actions>
            </v-card>
        </v-dialog>
        ...
        <v-dialog v-model="crewDialog" max-width="800">
            <v-card color="#ebfffe" light outlined>
                ...
                <v-card-actions>
                    <v-btn :color=secondaryColor text @click="crewDialog = false">Close</v-btn>
                </v-card-actions>
            </v-card>
        </v-dialog>
        ...
        <v-dialog v-model="passengerDialog" max-width="800">
            <v-card color="#ebfffe" light outlined>
                ...
                <v-card-actions>
                    <v-btn :color=secondaryColor text @click="passengerDialog = false">Close</v-btn>
                </v-card-actions>
            </v-card>
        </v-dialog>
    </v-app>
